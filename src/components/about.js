    ...
    return (
            ...
            <div className="about">
                ...
                <div className="col-2">
                    ...
                    <p className="pagragraph">I have bachelors in 💻 Computer Science from 🎓 the University of Central Asia. I have a serious passion for 🔥 UI effects, animations, and creating intuitive, dynamic user experiences. Over the years I have managed to build a range of 🕸️ and 📱 applications.</p>
